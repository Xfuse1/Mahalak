      ...
      <main className="flex-1 py-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-extrabold bg-gradient-to-r from-gray-800 via-blue-700 to-blue-600 bg-clip-text text-transparent mb-4">{t("aboutMahalak")}</h1>
            <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">{t("aboutDescription")}</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-10 text-white shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold mb-5">{t("ourVision")}</h2>
              <p className="text-white/90 leading-relaxed mb-4 text-lg">{t("visionText1")}</p>
              <p className="text-white/90 leading-relaxed text-lg">{t("visionText2")}</p>
            </div>
          </div>
        </div>
      </main>
