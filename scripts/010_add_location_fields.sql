-- Add location fields to profiles table for customer addresses
...
COMMENT ON COLUMN public.profiles.latitude IS 'Customer location latitude for delivery';
COMMENT ON COLUMN public.profiles.longitude IS 'Customer location longitude for delivery';
