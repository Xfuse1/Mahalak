      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">{t("home")}</h3>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="font-bold text-lg text-white">{t("quickLinks")}</h4>
          ...
          {/* Legal */}
          <div className="space-y-4">
            <h4 className="font-bold text-lg text-white">{t("termsAndPolicies")}</h4>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h4 className="font-bold text-lg text-white">{t("contact")}</h4>
